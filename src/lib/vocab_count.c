...
static PyObject *__pyx_pw_3src_8crucyble_3lib_11vocab_count_1vocab_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_corpus_file,&__pyx_n_s_output_file,&__pyx_n_s_verbose,&__pyx_n_s_max_vocab,&__pyx_n_s_min_count,&__pyx_n_s_log_file,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output_file)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("vocab_count", 1, 6, 6, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_verbose)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("vocab_count", 1, 6, 6, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_vocab)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("vocab_count", 1, 6, 6, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_min_count)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("vocab_count", 1, 6, 6, 4); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_log_file)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("vocab_count", 1, 6, 6, 5); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(vocab_count(__pyx_v_corpus_file, __pyx_v_output_file, __pyx_v_verbose, __pyx_v_max_vocab, __pyx_v_min_count, __pyx_v_log_file)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 *     return _vocab_count.vocab_count(corpus_file, output_file, verbose, max_vocab, min_count, log_file)
 */
  __pyx_tuple_ = PyTuple_Pack(6, __pyx_n_s_corpus_file, __pyx_n_s_output_file, __pyx_n_s_verbose, __pyx_n_s_max_vocab, __pyx_n_s_min_count, __pyx_n_s_log_file); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 6, __pyx_L1_error)
