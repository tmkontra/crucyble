...
#define __PYX_HAVE__vocab_count
#define __PYX_HAVE_API__vocab_count
/* Early includes */
...
/* Module declarations from 'vocab_count' */
#define __Pyx_MODULE_NAME "vocab_count"
extern int __pyx_module_is_main_vocab_count;
int __pyx_module_is_main_vocab_count = 0;

/* Implementation of 'vocab_count' */
...
static PyObject *__pyx_pf_11vocab_count_vocab_count(CYTHON_UNUSED PyObject *__pyx_self, char *__pyx_v_corpus_file, char *__pyx_v_output_file, int __pyx_v_verbose, PY_LONG_LONG __pyx_v_max_vocab, PY_LONG_LONG __pyx_v_min_count); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_11vocab_count_1vocab_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_11vocab_count_1vocab_count = {"vocab_count", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11vocab_count_1vocab_count, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_11vocab_count_1vocab_count(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("vocab_count.vocab_count", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11vocab_count_vocab_count(__pyx_self, __pyx_v_corpus_file, __pyx_v_output_file, __pyx_v_verbose, __pyx_v_max_vocab, __pyx_v_min_count);
...
static PyObject *__pyx_pf_11vocab_count_vocab_count(CYTHON_UNUSED PyObject *__pyx_self, char *__pyx_v_corpus_file, char *__pyx_v_output_file, int __pyx_v_verbose, PY_LONG_LONG __pyx_v_max_vocab, PY_LONG_LONG __pyx_v_min_count) {
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_vocab_count) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "vocab_count")) {
      if (unlikely(PyDict_SetItemString(modules, "vocab_count", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     return _vocab_count.vocab_count(corpus_file, output_file, verbose, max_vocab, min_count)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11vocab_count_1vocab_count, NULL, __pyx_n_s_vocab_count); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init vocab_count", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init vocab_count");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
